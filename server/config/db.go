...
type GeneralDB struct {
	...
	ConnMaxLifetime int    `mapstructure:"conn-max-lifetime" json:"conn-max-lifetime" yaml:"conn-max-lifetime"` // 连接最大生命周期，单位秒
	ConnMaxIdleTime int    `mapstructure:"conn-max-idle-time" json:"conn-max-idle-time" yaml:"conn-max-idle-time"` // 空闲连接最大存活时间，单位秒
